...
/**
  * NeshaWaves: Draws and animates a sine wave.
  * @author Zachary Ferguson 
  **/
public class NeshaWaves extends J1_1_Point
{
	/** Width of this frame. **/
	protected int width; 
	/** Height of the frame. **/
	...
	/**
	  * Main method for demoing the NeshaWaves class.
	  * @param args Command line arguments (Ignored).
	  **/
	public static void main(String[] args) 
	{
		/* Create a NeshaWaves frame. */
		NeshaWaves wave = new NeshaWaves(800, 200, 
			"NeshaWaves");
	...
	/**
	  * Creates an instance of the NeshaWaves class. Defaults: width = 
	...
	/**
	  * Creates an instance of the NeshaWaves class given the width, 
	  * height, radius, and title.
	  * @param width Width of the frame.
	  * @param height Height of the frame.
	  * @param title The title of the frame.
	  **/
	public NeshaWaves(int width, int height, String title)
	{
	...
	public void init(GLAutoDrawable drawable)
	{
		...
		gl.glClearColor(0.9843f, 0.8745f, 0.9176f, 0.0f);
	...
	public void drawWave(float origin_x, float origin_y)
	{
		...
		gl.glColor3f(0.9490f, 0.5922f, 0.6980f);
	...
	public void animatePointOnWave(float origin_x, float origin_y)
	{
		...
		gl.glColor3f(0.8235f, 0.6118f, 0.9490f);
